...
mask=y_ReadAll('MR_T2_hc_mdd_GRF_Vp0001_mask.nii');
ind_hc=(1:1079)';
ind_mdd=(1085:2234)';
...
file1=dir([data_dir,'/zROI2*HC*.nii']);
file2=dir([data_dir,'/zROI2*MDD*.nii']);
...
save ROImeanResults_MR.mat P T R;
...
save HDRScorrCluster_PT_MR.mat R_hdrs P_hdrs
saveas (gcf,'HDRScorrCluster_MR_PT.tiff');
close all
...
save DURcorrCluster_PT_MR.mat R_dur P_dur
saveas (gcf,'DURcorrCluster_MR_PT.tiff');
close all
