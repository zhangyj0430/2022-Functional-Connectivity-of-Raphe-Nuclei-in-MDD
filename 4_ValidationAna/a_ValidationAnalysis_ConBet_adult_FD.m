...
%% regional between-group analysis_FD
...
for n_seed=1:length(seed)
    ...
    DependentDirs={mdd;hc};
    [TTest2_T,Header] = y_TTest2_Image(DependentDirs,[seed{n_seed},'_T2_hc_mdd_FD'],Mask,[],Covariates);
    [GRF_Data_Corrected,ClusterSize,GRF_Header]=GRF([seed{n_seed},'_T2_hc_mdd_FD'],0.001,0,0.05,[seed{n_seed},'_T2_hc_mdd_FD_GRF'],Mask);
    BrainNet_MapCfg(surfacefile{n_seed},[seed{n_seed},'_T2_hc_mdd_FD_GRF.nii'],Cgf{n_seed},[seed{n_seed},'_T2_hc_mdd_FD_GRF.tif']);
end
